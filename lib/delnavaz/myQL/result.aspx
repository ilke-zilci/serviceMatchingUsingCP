...
<html xmlns="http://www.w3.org/1999/xhtml"><body><form id="form1" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: medium solid #C0C0C0; " align="center">
            <tr>
                 <td colspan="2" align="center" bgcolor="#003366" style="font-size: small; color: #FFFFFF; font-weight: bolder;" > request and results</td>
            </tr>            
            <tr>
                <td align="center" >
                    &nbsp;
            ...
            <tr>
                <td align="center">
                    <asp:Panel ID="Panel4" runat="server" GroupingText="Results" 
                        ...
                        <asp:Panel ID="Panel5" runat="server" GroupingText="Super-Exact Matches" 
                            HorizontalAlign="Center" >
                            <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" 
                                BorderStyle="Solid" BorderWidth="1px" CellPadding="4" HorizontalAlign="Center" Width="60%"
                                DataSourceID="SqlDataSource1" Font-Size="Small" ForeColor="#333333">
                                <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                                <Columns>
                                <asp:TemplateField HeaderText="rank order" ItemStyle-VerticalAlign="Middle" 
                                            ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                        ...
                        <br />
                        <asp:Panel ID="Panel6" runat="server" GroupingText="Partial Matches" 
                            HorizontalAlign="Center">
                            <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" 
                                ...
                                <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                                <Columns>
                                <asp:TemplateField HeaderText="rank order" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                     <%# Container.DataItemIndex + 1 %>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            ...
            <tr>
                <td bgcolor="#003366" colspan="2" >
                    <asp:Button ID="btnCancel" runat="server" Text="Home" CausesValidation="false" 
