...
public class SolveAsMatrixGreaterProblem extends AbstractProblem {
	/**
	...
	public SolveAsMatrixGreaterProblem() {
		// PROBLEM DEFINITION
		matching = ProblemFactory.newProblem("ServiceMatchingDiscreteNumeric");
	}

	public SolveAsMatrixGreaterProblem(int qosdemand[], int[][] qvalues) {
		// PROBLEM DEFINITION
		matching = ProblemFactory.newProblem("ServiceMatchingDiscreteNumeric");
	...
	public static void main(String[] args) throws ConstraintException {
		...
		SolveAsMatrixGreaterProblem matchp = new SolveAsMatrixGreaterProblem(
				qosdemand, qvalues);
